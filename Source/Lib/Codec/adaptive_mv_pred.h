...
#endif
#if CLN_MV_UNIT
bool svt_aom_warped_motion_parameters(struct ModeDecisionContext* ctx, const Mv mv,
...
#else
#if CLN_WM_SAMPLES
bool svt_aom_warped_motion_parameters(struct ModeDecisionContext* ctx, MvUnit* mv_unit,
...
void svt_av1_find_best_ref_mvs_from_stack(int allow_hp, CandidateMv ref_mv_stack[][MAX_REF_MV_STACK_SIZE],
                                          MacroBlockD *xd, MvReferenceFrame ref_frame, Mv *nearest_mv,
