...
void *packetization_kernel(void *input_ptr) {
    ...
    for (;;) {
            ...
            PictureControlSet *pcs_ptr =
                (PictureControlSet *)entropy_coding_results_ptr->pcs_wrapper_ptr->object_ptr;
            ...
            if (parent_pcs_ptr->superres_total_recode_loop > 0) {
                ...
                // Delayed call from Rest process
                {
                    ...
                    if (parent_pcs_ptr->is_used_as_reference_flag) {
                        ...
                        picture_demux_results_rtr->scs_wrapper_ptr =
                            parent_pcs_ptr->scs_wrapper_ptr;
            ...
            RateControlTasks *rate_control_tasks_ptr =
                (RateControlTasks *)rate_control_tasks_wrapper_ptr->object_ptr;
            rate_control_tasks_ptr->pcs_wrapper_ptr =
                pcs_ptr->picture_parent_control_set_wrapper_ptr;
            ...
            if (frm_hdr->show_frame) {
                ...
                metadata_sz = svt_metadata_size(temp_entry->metadata,
                                                EB_AV1_METADATA_TYPE_ITUT_T35);
            }
