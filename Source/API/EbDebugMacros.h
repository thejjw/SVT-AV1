...
// Modify normative tools for hardware-like constraints
...
#define OPT_HW_INTRA_SMOOTH   1 // Disable smooth-intra prediction mode (set to 0 to enable)
#define OPT_HW_INTRA_PAETH    1 // Disable paeth-h and paeth-v intra prediction modes (set to 0 to enable)
...
#define OPT_HW_CDEF           1 // Disable CDEF filter (set to 0 to enable)
...
// Modify non-normative tools for hardware-like constraints
...
#define OPT_HW_LIMIT_PA_ME    1 // Turn OFF pre-HME and HME; perform a 196×64 full-pel search around (0, 0) to avoid exceeding the reference encoder MV size
...
#endif
// Towards a Hardware-Friendly SVT-AV1 Encoder : Evaluation of The AV1 Tools
#define OPT_HW_AV1            0
#if OPT_HW_AV1
#define OPT_HW_AV1_CDEF       1 // Turn ON CDEF
#define OPT_HW_AV1_PART       1 // Tuen ON 64×64 block and the H4/V4 partitions of the 16×16 and 32×32 depths
#endif
// Additional tools
