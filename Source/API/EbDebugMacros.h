...
#if OPT_HW_AV1
// Part
#define OPT_HW_AV1_PART_V0    0  // Enable partitions: 64×64, 64×32, 32×64, 64×16, 16×64
#define OPT_HW_AV1_PART_V1    0  // Enable partitions: 32×64, 16×64
// TXT
#define OPT_HW_AV1_TXT        0  // Enable transform search (8 of 16 tx-types): DCT_DCT, V_DCT, H_DCT, ADST_ADST, ADST_DCT, DCT_ADST, FLIPADST_FLIPADST, IDTX
#endif
// Additional tools
